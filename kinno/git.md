...
* [git](#git)
  ...
  * [バージョン管理ツールを使う](#管理使)
  * [コンフィグファイル](#)
    * [コンフィグファイルの場所と優先順位](#場所優先順位)
    * [パーミッションの変更を検知させない](#変更検知)
  * [HEADと`~`，`^`](#head)
    * [HEAD](#head-1)
    * [HEADを起点としたコミットの遡り](#head起点遡)
      * [`~`チルダ](#-1)
      * [`^`キャレット](#-2)
  * [コマンド](#-3)
    * [1. ブランチ操作](#1-操作)
    ...
    * [2. コミット操作](#2-操作)
      * [直前のコミットのやり直し](#直前直)
      * [コミットの取り消し](#取消)
        * [`reset`を使う方法](#reset使方法)
        * [`revert`を使う方法](#revert使方法)
      * [取り消しの取り消し](#取消取消)
      * [コミットログの絞り込み](#絞込)
    * [3. ファイルの状態](#3-状態)
      * [特定ファイルを特定コミットの状態に戻す](#特定特定状態戻)
      * [編集中のファイルをHEADに戻す](#編集中head戻)
      * [削除してしまったファイルを復元する](#削除復元)
  * [バイナリ文章フォーマットの差分を取る](#文章差分取)
    * [インストールするもの](#-4)
    * [スクリプトの準備](#準備)
  * [参考資料](#参考資料)
    * [コミット操作](#操作)
    * [ファイルの状態](#状態)
    * [バイナリ文章フォーマットの差分を取る](#文章差分取-1)
